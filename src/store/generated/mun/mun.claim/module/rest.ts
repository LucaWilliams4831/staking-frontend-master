...
export interface ClaimClaimRecord {
  ...
  airdrop_id?: string;
  recipient?: string;
  initial_claimable_coins?: V1Beta1Coin[];
  claimable_coins?: V1Beta1Coin[];
  claimed_conditions?: ClaimConditionType[];
}
...
*/
export enum ClaimConditionType {
  CONDITION_TYPE_UNSPECIFIED = "CONDITION_TYPE_UNSPECIFIED",
  CONDITION_TYPE_INIT = "CONDITION_TYPE_INIT",
  CONDITION_TYPE_SWAP = "CONDITION_TYPE_SWAP",
  CONDITION_TYPE_STAKE = "CONDITION_TYPE_STAKE",
  CONDITION_TYPE_VOTE = "CONDITION_TYPE_VOTE",
}

export type ClaimMsgClaimResponse = object;
...
export interface ClaimQueryAirdropResponse {
  /** Airdrop defines airdrop information. */
  airdrop?: ClaimAirdrop;
}

export interface ClaimQueryAirdropsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mun/claim/airdrop/{airdrop_id}
   */
  queryAirdrop = (airdrop_id: string, params: RequestParams = {}) =>
    this.request<ClaimQueryAirdropResponse, RpcStatus>({
      path: `/mun/claim/airdrop/${airdrop_id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mun/claim/airdrops
   */
  queryAirdrops = (
    query?: {
    ...
    this.request<ClaimQueryAirdropsResponse, RpcStatus>({
      path: `/mun/claim/airdrops`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mun/claim/airdrops/{airdrop_id}/claim_records/{recipient}
   */
  queryClaimRecord = (airdrop_id: string, recipient: string, params: RequestParams = {}) =>
    this.request<ClaimQueryClaimRecordResponse, RpcStatus>({
      path: `/mun/claim/airdrops/${airdrop_id}/claim_records/${recipient}`,
      method: "GET",
      format: "json",
      ...params,
    });
